...
const mekanEkle = function (req, res) {
    ...
    Mekan.create({
        ...
        imkanlar: req.body.imkanlar.split(","), // virgul ile bolup diziye atariz.
        ...
        function (hata, mekan) {
            if (hata) {
                cevapOlustur(res, 400, hata); //req istek tutar
            }
            else {
...
const mekanGuncelle = function (req, res) {
    if (!req.params.mekanid) {
        ...
        return;
    } //- isareti yorumlar ve puan disinda her seyi almamizi soyler.
